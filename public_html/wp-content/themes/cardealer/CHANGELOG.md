## Version 6.1.1 (December 19, 2024)
* Fixed: Fixed Elementor Panel loading issue in Elementor editor.
* Updated: Updated bundled plugins.
* Updated: Updated language files.

## Version 6.1.0 (November 20, 2024)
* Added: Added new feature to display Lead Form Inquiries in Dealer Dashboard.
* Added: Added new feature to display seller contact buttons (WhatsApp, Call, Email) in vehicles on the vehicle list page.
* Added: Added Vehicle and Seller columns in all lead forms in Admin Panel.
* Added: Added lines to separate dropdown items in vehicle filter.
* Fixed: Fixed outdated WooCommerce templates.
* Fixed: Fixed issue to load vehicle inventory listing (archive) page when permalink is set to Plain.
...
## Version 6.0.5 (April 19, 2024)
* Fixed: Fixed "Read More" text translation issue in the Blog Posts 1 and Blog Posts 2 shortcode/widget.
* Updated: Updated bundled plugins.
* Updated: Updated language files.

## Version 6.0.4 (Apr 12, 2024)
* Fixed: Fixed translation issue with "Click to share" word on the vehicle detail page.
* Updated: Updated bundled plugins.
* Updated: Updated language files.

## Version 6.0.3 (March 06, 2024)
* Fixed: Fixed fatal error due to Subscriptio compatibility issue.
* Fixed: Fixed issue where mobile menu is not opening when Max Mega Menu is enabled.
* Fixed: Fixed WooCommerce Cart/Checkout Block design issues.
* Fixed: Fixed Redux Option new dropdown design issue.
* Fixed: Fixed header cart design issue.
* Fixed: Fixed minor header design issues.
* Fixed: Fixed mobile menu bar not working in some conditions.
* Updated: Added minor accessibility improvement.
* Updated: Updated bundled plugins.
* Updated: Updated language files.
* Various Minor code/formatting improvements and fixes.

## Version 6.0.2 (February 09, 2024)
* Fixed: Fixed issue in "Vehicle 360° View (Button)" and "Vehicle 360° View (Inline)" shortcodes/widgets.
* Fixed: Fixed menu highlight issue when vehicle detail page is open.
* Fixed: Fixed Elementor Pro conflict.
* Fixed: Fixed issue where Blog Posts 1 widget's Carousel View is not working in the Elementor editor.
* Updated: Updated Demo Preview links in the setup wizard.
* Updated: Updated bundled plugins.
* Updated: Updated language files.

## Version 6.0.1 (February 02, 2024)
* Fixed: Fixed display issue in Our Team widget.
* Fixed: Fixed minor design issues.
* Updated: Updated bundled plugins.
* Updated: Updated language files.

## Version 6.0.0 (February 01, 2024)
* Added: Added New Sample Data "Modern".
* Added: Added New Sample Data "Electro".
* Added: Added new 360° View feature in vehicles.
* Added: Added new 360° View shortcode/widget.
* Added: Added 2 new Header Styles.
* Added: Added new "Hero Vehicle Info" shortcode/widget.
* Added: Added new "Hotspot" shortcode/widget.
* Added: Added new "Color Variant" shortcode/widget.
* Added: Added new "App Buttons" shortcode/widget.
* Added: Added new "Video Button" shortcode/widget.
* Added: Added new "Blog Posts 1" shortcode/widget.
* Added: Added new "Blog Posts 2" shortcode/widget.
* Added: Added new style in the "Counter" shortcode/widget.
* Added: Added new style in the "Vehicle Search" shortcode/widget.
* Added: Added new style in the "Vehicles By Type" widget/shortcode.
* Added: Added new style in the "Custom Filter" shortcode/widget.
* Added: Added new styles in the "Section Title" shortcode/widget.
* Added: Added new styles in the "Newsletter" shortcode/widget.
* Added: Added new styles in the "Vehicle Showcase" shortcode/widget.
* Added: Added new styles in the "Info Box" shortcode/widget.
* Added: Added new "Design Options" settings in the "Vehicle Search" shortcode.
* Added: Added new "Design options" setting in the "Vehicles By Type" shortcode.
* Added: Added new "Design options" setting in the "Custom Filter" shortcode.
* Added: Added new Center Alignment option in the "Vehicle Price" shortcode/widget.
* Added: Added new Font Size field in section title shortcode.
* Added: Added new Line Height field in section title shortcode.
* Added: Added new setting in theme options to select a category or specific attribute to display related vehicles.
* Added: Added "Categories" filter in the Vehicle Inventory panel.
* Added: Added responsive options in WPBakery Row, Inner Row, Column, and Inner Column.
* Fixed: Fixed issue in vehicle filter.
* Fixed: Fixed image count error when user is not logged-in.
* Fixed: Fixed HTML validation errors.
* Fixed: Fixed PHP warning.
* Fixed: Fixed HTML validation errors.
* Fixed: Fixed text-domain.
* Fixed: Fixed PHPCS.
* Fixed: Fixed Typo.
* Updated: Updated team member social profile fields to extend and add new social services with custom code.
* Updated: Updated bundled plugins.
* Updated: Updated language files.
* Removed: Removed unwanted codes.
* Various Minor code/formatting improvements and fixes.

## Version 5.4.0 (October 03, 2023)
* Added: Added new theme option to enable/disable image count in the vehicle detail page image gallery.
* Added: Added new theme option to enable/disable image loop in the vehicle detail page image gallery.
* Added: Added new theme option to set the year to ascending/descending in the vehicle filter year dropdown.
* Added: Added new theme options "Enable Filters/Widgets in mobile" and "Off-canvas position" for off-canvas filter in mobile devices.
* Fixed: Fixed issue off-canvas filter not working in the mobile devices when "Listing Sidebar" is set to "No sidebar".
* Fixed: Fixed Price Range slider step is not working as per the Theme Option.
* Fixed: Fixed issue of sending mail when importing vehicles with the "WP All Import" plugin.
* Fixed: Fixed issue where, after adding the vehicle to the wishlist, the "Added to wishlist" label gets updated when the page is refreshed.
* Fixed: Fixed fatal error due to argument type.
* Fixed: Fixed design issue in the change address Update button on the WooCommerce Cart page.
* Fixed: Fixed issue where slider was not working properly on the vehicle detail page in the mobile view.
* Fixed: Fixed fatal error on some specific condition when TGMPA is unavailable.
* Fixed: Fixed text-domain.
* Updated: Changed icon for sort order in vehicle filters.
* Updated: Updated Custom Sidebars UI.
* Updated: Updated bundled plugins.
* Updated: Updated language files.
* Removed: Removed unwanted codes.
* Various Minor code/formatting improvements and fixes.

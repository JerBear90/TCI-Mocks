...
if ( ! function_exists( 'cardealer_elementor_register_location' ) ) {
	 ...
	 *
	 * @param Locations_Manager $location_manager An instance of locations manager.
	 * @return void
	 */
	function cardealer_elementor_register_location( $location_manager ) {
...
global $vc_manager;
if ( $vc_manager ) {
	require_once trailingslashit( CARDEALER_PATH ) . 'includes/vc/vc.php';
}

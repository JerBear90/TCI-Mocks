	...
	<div class="container">
		<div class="row">
			...
			if ( $testimonials_query->have_posts() ) {
				?>
				<div id="cd-testimonial-items" class="cd-testimonial-items <?php echo esc_attr( $layout_style ); ?>">
					<?php
								...
								<div class="testimonial-block text-center <?php echo esc_attr( $col_class ); ?>">
									...
									<div class="testimonial-box">
										<div class="testimonial-avtar">
											<img class="img-responsive" src="<?php echo esc_url( $profile_img[0] ); ?>" width="<?php echo esc_attr( $profile_img[1] ); ?>" height="<?php echo esc_attr( $profile_img[2] ); ?>" alt="<?php echo esc_attr( $title ); ?>">
											<h6><?php the_title(); ?></h6>
											<?php if ( $designation ) { ?>

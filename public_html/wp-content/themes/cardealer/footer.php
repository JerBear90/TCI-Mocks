			...
			<div class="car-top <?php echo esc_attr( $back_to_top_img_light ); ?>">
				<span>
					...
					if ( isset( $car_dealer_options['enable_lazyload'] ) && $car_dealer_options['enable_lazyload'] ) {
						?>
						<img class="cardealer-lazy-load" src="<?php echo esc_url( LAZYLOAD_IMG ); ?>" data-src="<?php echo esc_url( $back_to_top_img_url ); ?>" alt="<?php esc_attr_e( 'Top', 'cardealer' ); ?>" title="<?php esc_attr_e( 'Back to top', 'cardealer' ); ?>" style="width: 74px;height: 114px;">
						<?php
					} elseif ( $back_to_top_img_url ) {
						?>
						<img src="<?php echo esc_url( $back_to_top_img_url ); ?>" alt="<?php esc_attr_e( 'Top', 'cardealer' ); ?>" title="<?php esc_attr_e( 'Back to top', 'cardealer' ); ?>" style="width: 74px;height: 114px;">
						<?php
					}
					?>
				</span>

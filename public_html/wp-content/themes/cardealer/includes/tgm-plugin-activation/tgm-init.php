	...
	function cardealer_tgmpa_plugin_list() {
		...
		$required_plugins = array(
			array(
				...
				'source'             => cardealer_tgmpa_plugin_path( 'cardealer-helper-library-6.1.1.zip' ),
				'required'           => true,
			...
			array(
				...
				'slug'               => 'revslider',
				'source'             => cardealer_tgmpa_plugin_path( 'revslider-6.7.23.zip' ),
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false,
			...
			array(
				...
				'source'             => cardealer_tgmpa_plugin_path( 'advanced-custom-fields-pro-6.3.11.zip' ),
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false,
		...
		if ( ! $is_setup_wizard || ( $is_setup_wizard && array_key_exists( $page_builder, $page_builders ) && 'wpbakery' === $page_builder ) ) {
			$plugins[] = array(
				...
				'slug'               => 'js_composer',
				'source'             => cardealer_tgmpa_plugin_path( 'js_composer-8.1.0.zip' ),
		...
		$recommended_plugins = array(
			array(
				...
				'source'             => cardealer_tgmpa_plugin_path( 'cardealer-front-submission-3.12.0.zip' ),
			...
			array(
				...
				'slug'               => 'envato-market',
				'source'             => cardealer_tgmpa_plugin_path( 'envato-market-2.0.12.zip' ),
				'required'           => false,
				'force_activation'   => false,
				'force_deactivation' => false,
				'version'            => '2.0.12',
		...
		if ( cardealer_tgmpa_is_subscriptio_enabled() ) {
			$recommended_plugins[] = array(
				...
				'slug'               => 'subscriptio',
				'source'             => cardealer_tgmpa_plugin_path( 'subscriptio-3.0.7.1.zip' ),
				'required'           => cardealer_tgmpa_is_cdfs_active(),
				'force_activation'   => false,
				'force_deactivation' => false,
...
if ( ! function_exists( 'cardealer_tgmpa_plugins_data' ) ) {
	...
	function cardealer_tgmpa_plugins_data() {
		...
		$pluginx = $tgmpax ? $tgmpax->plugins : array();
...
function cardealer_tgmpa_init_fix() {
	...
	if ( $tgmpa_instance && true === $tgmpa_instance->is_tgmpa_complete() ) {

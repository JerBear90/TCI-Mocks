...
<div class="wrap cardealer-admin-theme-page cardealer-admin-wrap cardealer-system-status cardealer-admin-status-screen">
	...
	<div class="cardealer-debug-tab-container">
		<div class="cardealer-debug-tab-lists">
			...
			foreach ( $cardealer_debug_tabs as $tab_k => $tab_data ) {
				...
				?>
				<div class="cardealer-debug-tab"><a href="#" data-tag="<?php echo esc_attr( $tab_k ); ?>" class="<?php echo esc_attr( $tab_class ); ?>"><?php echo esc_html( $tab_data['title'] ); ?></a></div>
				<?php

...
// Vehicle Seller Contacts
add_action( 'cardealer/vehicle-list-item/view-grid/list-style-classic/car-footer', 'cardealer_vehicle_list_item_seller_contacts' );
add_action( 'cardealer/vehicle-list-item/view-grid/list-style-default/car-footer', 'cardealer_vehicle_list_item_seller_contacts' );

...
foreach ( $rowarray[$x] as $review ) 
{
	...
	if($currentform[0]->display_num>0){
		...
		$readmorepopup = $templateclass->wprevpro_get_readmorepop($review,$template_misc_array,$starhtml,$tempreviewername,$userpic,$tempuserpic,$datestring,$title,$logo,$media);

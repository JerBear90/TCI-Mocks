...
<div class="author-info port-post clearfix">
	...
	<div class="author-details port-post-info">
		...
		?>
		<h3 class="text-blue"><span><?php esc_html_e( '', 'cardealer' ); ?> </span><a title="<?php echo esc_attr( $author_link_title ); ?>" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author"><?php echo get_the_author(); ?></a></h3>
		<?php

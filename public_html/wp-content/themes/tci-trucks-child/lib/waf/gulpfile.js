...
// Scripts copied for use in external script tags
const EXTSCRIPTS = [
...
gulp.task( 'serve', ['sass'], () => {
    browserSync.init({
        proxy: "http://brainy-forms",
        logLevel: 'debug',
        files: [APPPATH.root,APPPATH.php]
    });
})

// Watch for changes
gulp.task( 'watch', ['src-fonts','serve','inject','src-fonts','images', 'js' ], () => {
    gulp.watch( [SOURCEPATHS.sassSource], ['sass'])
    gulp.watch( [SOURCEPATHS.phpSource], browserSync.reload() );
